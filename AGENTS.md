...
- `packages/excel-core/src/core/AGENTS.md` — 内核与事务
- `packages/excel-core/src/formula/AGENTS.md` — 公式
- `packages/excel-view/src/view/AGENTS.md` — Konva 视图
- `packages/excel-view/src/plugins/AGENTS.md` — 插件
- `packages/excel-react/src/AGENTS.md` — React 外壳

横切：

- `.Codex/rules/testing.md`
- `.Codex/rules/react-components.md`
